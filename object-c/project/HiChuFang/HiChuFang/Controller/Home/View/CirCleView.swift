...
//        self.lastImageView.image = self.imageArray[self.getLastImageIndex(indexOfCurrentImage: self.indexOfCurrentImage)]
        ...
        self.currentImageView .kf_setImageWithURL(URL(string: String(self.imageArray[self.indexOfCurrentImage])))
        self.nextImageView.kf_setImageWithURL(URL(string: String(self.imageArray[self.getNextImageIndex(indexOfCurrentImage: self.indexOfCurrentImage)])))
        self.lastImageView.kf_setImageWithURL(URL(string: String(self.imageArray[self.getLastImageIndex(indexOfCurrentImage: self.indexOfCurrentImage)])))
    }
